...
export declare enum ConfigKey {
    ...
    USE_DEFAULT_TITLE = "useDefaultTitle",
...
export type HttpErrorCode = MPSRetCodes | RetCodes | WorkerRetCodes | SDKErrorCode | TTSCRetCodes;
...
export interface MediaViewState {
    mediaViewShow: boolean;
    mediaViewCurId: string;
}
